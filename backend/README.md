...
Install tremt.intranet2 with uv.

```shell
uv add tremt.intranet2
```
...
- [Issue tracker](https://github.com/lcpgeop/intranet2-tremt/issues)
- [Source code](https://github.com/lcpgeop/intranet2-tremt/)
...
Generated from the [`cookieplone-templates`  template](https://github.com/plone/cookieplone-templates/tree/main/) on 2025-09-25 19:02:32.. A special thanks to all contributors and supporters!
